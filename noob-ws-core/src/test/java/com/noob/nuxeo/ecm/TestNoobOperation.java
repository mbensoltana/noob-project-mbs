...
public class TestNoobOperation {
    ...
    public void shouldCallTheOperation() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, NoobOperation.ID);
    ...
    public void shouldCallWithParameters() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, NoobOperation.ID, params);
